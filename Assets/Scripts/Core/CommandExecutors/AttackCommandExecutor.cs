...
namespace Core.CommandExecutors
{
    public class AttackCommandExecutor : CommandExecutorBase<IAttackCommand>
    {
        ...
        [Inject(Id = "AttackingDistance")] private float _attackingDistance;
        [Inject(Id = "AttackingPeriod")] private int _attackingPeriod;
        ...
        private void StartAttackingTargets(IAttackable target)
        {
            ...
            _animator.SetTrigger(Animator.StringToHash(UnitAnimationType.ATTACK.ToString()));
